...
**WARNING**: PLua was an experimentation with the Pandoc Lua
interpreter. Its features have been integrated to
[LuaX](https://github.com/CDSoft/luax) and is no longer maintained.
